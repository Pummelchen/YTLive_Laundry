...
[![Views (14d)](https://img.shields.io/badge/Views_(14d)-30-blueviolet)](https://github.com/Pummelchen/YTLive_Laundry)
...
there and stays a by-hand host gate:
    ...
    tests/run.sh          738 checks, credential-free: no camera, network, ffmpeg or credentials,
